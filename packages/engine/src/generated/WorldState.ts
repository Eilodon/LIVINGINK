...
export class WorldState {
    ...
    constructor(config?: IWorldConfig) {
        ...
        if (config?.buffers?.tattoo) {
            ...
            this.tattooBuffer = new ArrayBuffer(this.maxEntities * 20);
        }
...
// EIDOLON-V: defaultWorld singleton REMOVED
// All consumers MUST use new WorldState() or inject WorldState instance.
// See Finding 1 in AUDIT_REPORT_EIDOLON_V.md
